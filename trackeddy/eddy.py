...
class Eddy():
    ...
    def __init__(self,contour,level) -> None:
        # Define all the object variables needed for the identification of an eddy.
    ...
    def to_dict(self,out_properties=None) -> dict:
        ...
        -------
        dict
            Dictionary including all the eddy properties defined in the out_properties list.
    ...
    def to_table(self,out_properties=None,**kwards) -> pd.DataFrame:
        ...
        -------
        pd.DataFrame
            Pandas table including all the eddy properties defined in the out_properties list.
        """
